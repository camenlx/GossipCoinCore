...
This means one can have an always-on gossipcoind instance running, and another local gossipcoind/gossipcoin-qt instance which connects to this node and receives blocks from it.
