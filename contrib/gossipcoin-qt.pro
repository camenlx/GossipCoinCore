...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/gossipcoin-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/gossipcoin-cli.cpp \
           src/gossipcoin-tx.cpp \
           src/gossipcoin.cpp \
           src/db.cpp \
           ...
           src/qt/gossipcoin.cpp \
           src/qt/gossipcoinstrings.cpp \
...
RESOURCES += src/qt/gossipcoin.qrc src/qt/gossipcoin_locale.qrc

TRANSLATIONS += src/qt/locale/gossipcoin_bg.ts \
                src/qt/locale/gossipcoin_de.ts \
                src/qt/locale/gossipcoin_en.ts \
                src/qt/locale/gossipcoin_es.ts \
                src/qt/locale/gossipcoin_fi.ts \
                src/qt/locale/gossipcoin_fr.ts \
                src/qt/locale/gossipcoin_it.ts \
                src/qt/locale/gossipcoin_ja.ts \
                src/qt/locale/gossipcoin_pl.ts \
                src/qt/locale/gossipcoin_pt.ts \
                src/qt/locale/gossipcoin_ru.ts \
                src/qt/locale/gossipcoin_sk.ts \
                src/qt/locale/gossipcoin_sv.ts \
                src/qt/locale/gossipcoin_vi.ts \
                src/qt/locale/gossipcoin_zh_CN.ts \
                src/qt/locale/gossipcoin_zh_TW.ts
