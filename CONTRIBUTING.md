Contributing to Gossipcoin Core
============================

The Gossipcoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Gossipcoin Core project, and is not to be
confused with overall Gossipcoin Network Protocol consensus changes.

Whether a pull request is merged into Gossipcoin Core rests with the project merge
...
Patches that change Gossipcoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Gossipcoin consensus, it must have been
...
The project leader is the release manager for each Gossipcoin Core release.
