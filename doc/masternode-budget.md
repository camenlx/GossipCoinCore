...
GOSSIP now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
When block `1000000` is reached you'll receive a payment for `1200` GOSSIP Coin.
 ...
 * vote-many          - Vote on a GOSSIP initiative
 * vote-alias         - Vote on a GOSSIP initiative
 * vote               - Vote on a GOSSIP initiative/budget
