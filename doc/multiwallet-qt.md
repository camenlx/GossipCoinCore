...
In order to support loading of multiple wallets in gossipcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is gossipcoin.cpp.
...
Changes to gossipcoin.cpp
----------------------
gossipcoin.cpp is the entry point into gossipcoin-qt, and as such, will require some minor modifications to provide hooks for
