...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x000003c1687f7f9685cffe243a7d08bf183cfb75fd748103994d62c6a7a75b2a"));
...
public:
    CMainParams()
    {
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1525981707;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 648064;
...
public:
    CTestNetParams()
    {
        ...
        // Testnet gossipcoin BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet gossipcoin BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // Gossipcoin: 1 day
        nTargetSpacing = 1 * 60;        // Gossipcoin: 1 minutes
