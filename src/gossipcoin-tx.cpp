...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Gossipcoin Core gossipcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  gossipcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded gossipcoin transaction") + "\n" +
                               "  gossipcoin-tx [options] -create [commands]   " + _("Create hex-encoded gossipcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded gossipcoin transaction
