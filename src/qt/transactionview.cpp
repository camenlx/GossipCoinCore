                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received Gossipcoin from zGOSS"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zGOSS"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zGOSS));
