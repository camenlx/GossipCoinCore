...
/** Utility functions used by the Gossipcoin Qt UI.
 */
namespace GUIUtil
{
...
// Render Gossipcoin addresses in monospace font
...
// Parse "gossipcoin:" URI into recipient object, return true on successful parsing
