...
QString TransactionTableModel::formatTxType(const TransactionRecord* wtx) const
{
    ...
    case TransactionRecord::ZerocoinMint:
        return tr("Converted Gossipcoin to zGOSS");
    case TransactionRecord::ZerocoinSpend:
        return tr("Spent zGOSS");
    case TransactionRecord::RecvFromZerocoinSpend:
        return tr("Received Gossipcoin from zGOSS");
    case TransactionRecord::ZerocoinSpend_Change_zGOSS:
        return tr("Minted Change as zGOSS from zGOSS Spend");
    case TransactionRecord::ZerocoinSpend_FromMe:
        return tr("Converted zGOSS to Gossipcoin");
