...
public:
    ...
    void setZGossipcoinControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzGOSS_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzGOSS_clicked();
    void on_pushButtonZGossipcoinControl_clicked();
