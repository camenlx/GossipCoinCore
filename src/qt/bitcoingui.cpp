                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Gossipcoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Gossipcoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and gossipcoin: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zGOSS"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Gossipcoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Gossipcoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Gossipcoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Gossipcoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Gossipcoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a Gossipcoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Gossipcoin Core help message to get a list with possible Gossipcoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Gossipcoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Gossipcoin network", "", count));
}
...
{
    QString strTitle = tr("Gossipcoin Core"); // default title
...
/** Creates context menu, its actions, and gossipcoins up all the relevant signals for mouse events. */
