...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Gossipcoin Core"),
     ...
     * override -datadir in the gossipcoin.conf file in the default data directory
     * (to be consistent with gossipcoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
