...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Gossipcoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Gossipcoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Gossipcoin features */
        {"gossipcoin", "masternode", &masternode, true, true, false},
        {"gossipcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"gossipcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"gossipcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"gossipcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"gossipcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"gossipcoin", "startmasternode", &startmasternode, true, true, false},
        {"gossipcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"gossipcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"gossipcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"gossipcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"gossipcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"gossipcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"gossipcoin", "mnbudget", &mnbudget, true, true, false},
        {"gossipcoin", "preparebudget", &preparebudget, true, true, false},
        {"gossipcoin", "submitbudget", &submitbudget, true, true, false},
        {"gossipcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"gossipcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"gossipcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"gossipcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"gossipcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"gossipcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"gossipcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"gossipcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"gossipcoin", "mnsync", &mnsync, true, true, false},
        {"gossipcoin", "spork", &spork, true, true, false},
        {"gossipcoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"gossipcoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use gossipcoind, or the -server option to gossipcoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> gossipcoin-cli " + methodname + " " + args + "\n";
}
